...
const BookingManagement = () => {
    ...
    const handleEditClick = (booking) => {
        ...
        // Ensure pricePerNight is correctly extracted from roomId
        const pricePerNight = booking.roomId?.pricePerNight || 100;

        setSelectedBooking({
            ...booking,
            checkInDate: booking.checkInDate.split("T")[0],  // Ensure correct date format
            checkOutDate: booking.checkOutDate.split("T")[0],
            pricePerNight: pricePerNight, // Use the correct pricePerNight
        });
    ...
    const handleDateChange = (e, field) => {
        ...
        if (updatedBooking.checkInDate && updatedBooking.checkOutDate) {
            updatedBooking.totalAmount = calculateTotalAmount(
                ...
                updatedBooking.pricePerNight // Use the correct pricePerNight
            );
        }
    ...
    const handleEditSave = async () => {
        ...
        try {
            ...
            console.log("Updated Booking Response:", response.data); // Debugging
